...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','Underline','StrikeThrough','-','TextColor','Image','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','OrderedList','UnorderedList','-','Link','Unlink','-','FontFormat','About']
] ;
